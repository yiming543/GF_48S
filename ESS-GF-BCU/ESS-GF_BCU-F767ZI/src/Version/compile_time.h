...
* __DATE__ __TIME__ => __TIME_UNIX__ 
...
//Compiler __DATE__ and __TIME__
...
#define MIN_PER_DAY     (24UL*MIN_PER_HOUR)
#define MIN_PER_YEAR    (MIN_PER_DAY*365UL)
#define BCU_START_YEAR	(2022)

//8-digit  2017-01-01 mm-dd-hh-mm 12051225 (uint32-t) => BUILD NUMBER 0
#define __AUTO_BUILD_NUMBER__   ( ((__TIME_YEARS__-BCU_START_YEAR)*12+__TIME_MONTH__)*1000000UL+       \
                                    __TIME_DAYS__*10000UL+      \
									__TIME_HOURS__*100+			\
									__TIME_MINUTES__)                   
