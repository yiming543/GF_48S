...
/* ADC modes */
	    ...
	    typedef enum
	    {
		    CVMIN_DEFAULT = 0, /* No threshold is enabled. The ?V results for CVOW are reported as measured,
		                                ...
		                                CVMIN_01, /* Initial cell voltage threshold = VREF1 กั 1/4 (0.8 V typical).*/
		                                CVMIN_10, /* Initial cell voltage threshold = VREF1 กั 3/8 (1.2 V typical).*/
		                                CVMIN_11,
		    /* Initial cell voltage threshold = VREF1 กั 1/2 (1.6 V typical)*/
	    } CVMIN;
