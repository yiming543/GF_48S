...
#define LSIFREQ (45000)
	...
	Calculated_timeout = (float)((float)(Prescaler * ReloadValue)) / LSIFREQ;
	printf(" WATCHDOG set with prescaler:%d reload value: 0x%X \r\n", Prescaler, ReloadValue);
	printf(" WATCHDOG timeout:%dms \r\n", (int)(Calculated_timeout * 1000));
