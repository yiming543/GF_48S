/**
  ******************************************************************************
  * @file      stm32h7xx_STLRamMcMxGCC.s
 ...
 *          R3 .. Backup area to save preserved registers content
 *          > R4 .. result status (local)
 *          > R5  .. pointer to RAM (local)
 *          > R6  .. content RAM to compare (local)
 *          > R7 .. Inverted bacground pattern
